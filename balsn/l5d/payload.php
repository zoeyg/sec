...
class L5D_Login {
    ...
    function __wakeup() {
        echo "L5D_Login.__wakeup\n";
        $this->login();
    }

    function __destruct() {
      echo "L5D_Login.__destruct\n";
        $this->logout();
    }
...
$obj = unserialize('O:9:"L5D_Login":1:{s:8:"p4ssw0rd";s:1:"p";}');
