...
previous script and proxy in a new interactive connection we know that works.
...
The full `redis-proxy.py` script is available at , and the modified `redis-rogue-server.py` script is available at .